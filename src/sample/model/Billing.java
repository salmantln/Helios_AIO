...
import sample.controller.BillingController;
...
public class Billing {
    ...
    public static void save() {
        for(Map.Entry<String, ProfileObject> profiles : MainApplication.profiles.entrySet())
    ...
    public static void save(String name, ProfileObject profile) {
        ...
        MainApplication.profiles.put(name, profile);
    }
    ...
    public static class Shipping {
        ...
        public Shipping(String firstName, String lastName, String address, String address2,  String city, BillingController.State state,
        ...
        public BillingController.State getState() {
            return state;
        }
        ...
        private String city;
        private BillingController.State state;
        private String zip;
